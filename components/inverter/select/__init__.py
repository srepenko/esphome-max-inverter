...
CONF_CAHRGER_SOURCE_PRIORITY = "charger_source_priority"
CONF_CHARGING_DISCHARGING_CONTROL = "charging_discharging_control"

InverterSelect = inverter_ns.class_("InverterSelect", cg.Component, select.Select)
...
TYPES = {
    ...
    CONF_CAHRGER_SOURCE_PRIORITY: ("PCP00", None),
...
PIPSELECT_SCHEMA = select.SELECT_SCHEMA.extend(
    {
        cv.GenerateID(): cv.declare_id(InverterSelect),
